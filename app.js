...
exportJson.onclick=()=>download("lyrics_tapper_project.json",JSON.stringify({app:"歌詞ハイ！タイマー",version:9,lyricText:lyrics.value,state},null,2),"application/json");
